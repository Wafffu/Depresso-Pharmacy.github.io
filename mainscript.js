    ...
    return newValue;
            ...
            setInterval(function moniPerSecond(){
                moniPS = workers + newss * 5 + students * 10 + migrants * 33 + tvs * 123 + scienses * 1000 + overseers * 9000 + childs * 25000 + spams * 69000 + researchers * 1240000 + tests * 75000000 + robos * 690000000 + zeppelins * 2200000000 + neuros * 13500000000 + SPACEHYPNOLASERs * 999999999999;
                document.getElementById('moniPS').innerHTML = abbreviateNumber(moniPS);
            }, 1000);
